...
> **Note**
> Everywhere in this repository, make sure to replace `ATamblingPoder/heckerOS` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
Read [the README in the `scripts/` directory](https://github.com/ATamblingPoder/heckerOS/blob/main/scripts/README.md) for more information.
...
To run the action, simply edit the `boot_menu.yml` by changing all the references to `ATamblingPoder/heckerOS` to your repository. This should trigger the action automatically.
